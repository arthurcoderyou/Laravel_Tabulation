...
<!--Page Breadcrumb-->
    @php 
        ...
        $main_title = "Contestants"; //Header title
    @endphp
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-md-flex">
                    <div class="col-sm-6">
                        <h4 class="card-title">{{ $contest->contest_name }} Contestants</h4>
                        <h5 class="card-subtitle">Select Contestant to Update/Delete/View</h5>
                    </div>
                    <div class="col-sm-6">
                        <a href="/admin/contestant/contestant_add/{{ $contest->id }}" class="btn btn-dark ml-auto">Add New Contestant</a>
                    </div>
                                  ...
                                  @endforeach
                                    <tr>
                                        ...
                                        <td class="text-center text-wrap" >
                                            {{ $contestant->contestant_message }}
                                        </td>
                                        <td class="text-center">
                                            <a href="/admin/contestant/contestant_update/{{ $contestant->id }}/{{ $contest->id }}" class="btn btn-info text-light">Update</a>
                                        </td>
                                        <td class="text-center">
                                            <form action="/admin/contestant/contestant_delete" method="post">
                                                @csrf
                                                <input name="c_id" type="hidden" value="{{ $contestant->id }}">
