    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-md-flex">
                    <div class="col-sm-6">
                        <h4 class="card-title">Criterias Contests</h4>
                        <h5 class="card-subtitle">Select Contest to Update/Delete/View Criterias</h5>
                    </div>
                            ...
                            @else
                                @foreach ($contests as $contest)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/criteria/criterias/{{ $contest->id }}" class="btn btn-info text-light">View Criterias</a>
                                        </td>
