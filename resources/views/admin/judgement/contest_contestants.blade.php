        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-md-flex">
                    ...
                    <div class="col-sm-6">
                        <a href="/admin/judgement/contest_judges/{{ $contest->id }}" class="btn btn-dark">Back to Judges</a>
                    </div>
                                ...
                                @foreach ($contestants as $contestant)
                                  ...
                                  @endforeach
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/judgement/contestant_scoring/{{ $judge->id }}/{{ $contest->id }}/{{ $contestant->id }}" class="btn btn-info text-light {{ ($jdg) ? 'disabled' : '' }}" {{ ($jdg) ? 'disabled' : '' }}>Give Contest Score</a>
                                        </td>

                                        <td class="text-center">
                                            <form action="/admin/judgement/contestant_scoring_reset" method="post">
                                                @csrf
