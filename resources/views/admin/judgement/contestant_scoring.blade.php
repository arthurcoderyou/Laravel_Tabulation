        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-md-flex">
                    ...
                    <div class="col-sm-6">
                        <a href="/admin/judgement/contest_contestants/{{ $judge->id }}/{{ $contest->id }}" class="btn btn-dark ml-auto">Back to Contestants</a>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0 align-middle text-nowrap">
                        ...
                        <tbody>
                          <form action="/admin/judgement/contestant_scoring_store" method="post" >
                            @csrf
