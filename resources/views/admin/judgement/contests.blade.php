            ...
            <div class="card-body">
                ...
                <div class="d-md-flex">
                    <div class="col-sm-6">
                        ...
                        <h5 class="card-subtitle">Select Contest to view Judges to give Contest Scores</h5>
                    </div>
                            ...
                            @else
                                @foreach ($contests as $contest)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/admin/judgement/contest_judges/{{ $contest->id }}" class="btn btn-info text-light">View Judges</a>
                                        </td>
